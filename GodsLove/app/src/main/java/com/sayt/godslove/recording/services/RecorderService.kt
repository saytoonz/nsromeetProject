...
import com.sayt.godslove.recording.FINISH_NOTIFICATION_CHANNEL_ID
import com.sayt.godslove.recording.RecorderActivity
import com.sayt.godslove.R
import com.sayt.godslove.recording.RECORDING_NOTIFICATION_CHANNEL_ID
import com.sayt.godslove.recording.data.DataManager
import com.sayt.godslove.recording.data.MediaStoreDataSource
import com.sayt.godslove.recording.data.SAFDataSource
...
class RecorderService : Service() {
    ...
    private val openAppPendingIntent: PendingIntent
        get() {
            val openAppIntent = Intent(this, RecorderActivity::class.java)
    ...
    private fun showFinishNotification(uri: SaveUri) {
        val contentIntent = PendingIntent.getActivity(
            this, 0,
            Intent(this, RecorderActivity::class.java), PendingIntent.FLAG_UPDATE_CURRENT
        )
    ...
    companion object {
        ...
        const val ACTION_RECORDING_START = "com.sayt.godslove.recording.action.RECORDING_START"
        const val ACTION_RECORDING_STOP = "com.sayt.godslove.recording.action.RECORDING_STOP"
        const val ACTION_RECORDING_PAUSE = "com.sayt.godslove.recording.action.RECORDING_PAUSE"
        const val ACTION_RECORDING_RESUME = "com.sayt.godslove.recording.action.RECORDING_RESUME"
        ...
        const val ACTION_RECORDING_COMPLETED =
            "com.sayt.godslove.recording.action.RECORDING_COMPLETED"
        const val ACTION_RECORDING_DELETED = "com.sayt.godslove.recording.action.RECORDING_DELETED"
