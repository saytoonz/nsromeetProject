...
import com.nsromapa.nsromeet.OnButtonSwitchedListener;
...
public class LoginButton extends View {
    ...
    private void init() {
        ...
        signUpButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.secondPage));
        ...
        loginPaint.setColor(ContextCompat.getColor(getContext(), R.color.white));
        ...
        signUpPaint.setColor(ContextCompat.getColor(getContext(), R.color.white));
        signUpPaint.setTextSize(dpToPixels(28));
...
//        signUpPaint.setAlpha(255);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        loginTextOutline.offset(width / 2 - (loginTextOutline.right + loginTextOutline.left) / 2, (int) dpToPixels(380));
        signUpTextOutline.offset(width / 2 - (signUpTextOutline.right + signUpTextOutline.left) / 2, (int) dpToPixels(380));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isLogin) {
            canvas.drawText(getString(R.string.sign_up), width / 2, dpToPixels(380), signUpPaint);
        } else {
            canvas.drawText(getString(R.string.login), width / 2, dpToPixels(380), loginPaint);
        }
...
//        animator.setInterpolator(new AccelerateInterpolator());
        animator.addUpdateListener(animation -> {
            ...
            if (isLogin) {
                ...
                currentLoginY = startLoginY - ((startLoginY - dpToPixels(380)) * fraction);
                ...
                currentSignUpTextY = startSignUpTextY - ((startSignUpTextY - dpToPixels(380)) * fraction);
